...
card_content_dataScience = [
    ...
    dbc.CardBody(
        [
            html.H5("Data Science to help your business", className="card-title"),
            html.P(
            ...
            dbc.Button("Make prediction", color="primary", href="/apps/business"),
        ]
    ),
]
...
card_content_OCR = [
    ...
    dbc.CardBody(
        [
            html.H5("Optical character recognition", className="card-title"),
            html.P(
...
card_content_time = [
    ...
    dbc.CardBody(
        [
            html.H5("Time-series prediction and clasterisation", className="card-title"),
            html.P(
...
card_content_vision = [
    ...
    dbc.CardBody(
        [
            html.H5("Computer Vision and Human Recognition", className="card-title"),
            html.P(
            ...
            dbc.Button("Try it", color="primary", href='/apps/cv'),
        ]
    ),
]
...
card_content_monitor = [
    ...
    dbc.CardBody(
        [
            html.H5("Online process monitoring", className="card-title"),
            html.P(
...
card_content_online = [
    ...
    dbc.CardBody(
        [
            html.H5("Natural Language Processing", className="card-title"),
            html.P(
            ...
            dbc.Button("Try", color="primary", href='/apps/sentiment'),
        ]
    ),
]
...
card_content_scrap = [
    ...
    dbc.CardBody(
        [
            html.H5("Web scapping and processing", className="card-title"),
            html.P(
...
card_content_reports = [
    ...
    dbc.CardBody(
        [
            html.H5("Report creation", className="card-title"),
            html.P(
            ...
            dbc.Button("Report example", color="primary", disabled=True),
        ]
    ),
]
